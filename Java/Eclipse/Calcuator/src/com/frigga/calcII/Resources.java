...
public class Resources {
	...
	public Resources() {
		...
		button1.setIcon(new ImageIcon("Media\\1.png"));
		
		button2.setPreferredSize(new Dimension(50,50));
		button2.setIcon(new ImageIcon("Media\\2.png"));

		button3.setPreferredSize(new Dimension(50,50));
		button3.setIcon(new ImageIcon("Media\\3.png"));
		
		button4.setPreferredSize(new Dimension(50,50));
		button4.setIcon(new ImageIcon("Media\\4.png"));
		
		button5.setPreferredSize(new Dimension(50,50));
		button5.setIcon(new ImageIcon("Media\\5.png"));
		
		button6.setPreferredSize(new Dimension(50,50));
		button6.setIcon(new ImageIcon("Media\\6.png"));
		
		button7.setPreferredSize(new Dimension(50,50));
		button7.setIcon(new ImageIcon("Media\\7.png"));
		
		button8.setPreferredSize(new Dimension(50,50));
		button8.setIcon(new ImageIcon("Media\\8.png"));
		
		button9.setPreferredSize(new Dimension(50,50));
		button9.setIcon(new ImageIcon("Media\\9.png"));
		
		button0.setPreferredSize(new Dimension(50,50));
		button0.setIcon(new ImageIcon("Media\\0.png"));
		
		buttonadd.setPreferredSize(new Dimension(50,50));
		buttonadd.setIcon(new ImageIcon("Media\\sum.png"));
		
		buttonmul.setPreferredSize(new Dimension(50,50));
		buttonmul.setIcon(new ImageIcon("Media\\mul.png"));
		
		buttonsub.setPreferredSize(new Dimension(50,50));
		buttonsub.setIcon(new ImageIcon("Media\\sub.png"));
		
		buttondiv.setPreferredSize(new Dimension(50,50));
		buttondiv.setIcon(new ImageIcon("Media\\div.png"));
		
		buttonclear.setPreferredSize(new Dimension(50,97));
		buttonclear.setIcon(new ImageIcon("Media\\clear.png"));
		
		buttonres.setPreferredSize(new Dimension(50,97));
		buttonres.setIcon(new ImageIcon("Media\\equal.png"));
		
		buttondot.setPreferredSize(new Dimension(50,50));
		buttondot.setIcon(new ImageIcon("Media\\dot.png"));
